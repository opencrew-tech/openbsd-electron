...
MODBERRY_CMD_EXTRACT?=\
	${SETENV} ${MODBERRY_ENV} ${MODBERRY_ENV_EXTRACT} ${MODBERRY_BIN}
MODBERRY_CMD_BUILD?=\
	${SETENV} ${MAKE_ENV} ${MODBERRY_ENV} ${MODBERRY_ENV_BUILD} \
	    ${MODBERRY_BIN}
MODBERRY_CMD_TEST?=\
	${SETENV} ${MODBERRY_ENV} ${MODBERRY_ENV_TEST} ${MODBERRY_BIN}
MODBERRY_CMD_GEN?=\
